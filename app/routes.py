...
# Sekarang impor ini akan berfungsi karena path root sudah ditambahkan
from app.encoder_backend import process_encoding
from app.decoder_backend import process_decoding
